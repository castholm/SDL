...
pub fn build(b: *std.Build) void {
    ...
    const build_config_h = addBuildConfigH(b, target, optimize);
    ...
    sdl3_mod.addIncludePath(b.path("include/SDL3"));
    sdl3_mod.addAfterIncludePath(b.path("src/video/khronos"));

    sdl3_mod.addCSourceFiles(.{ .files = &c_files, .flags = &c_flags });
    if (linkage == .dynamic) {
    ...
    sdl3_lib.installHeadersDirectory(b.path("include"), "", .{ .include_extensions = &pub_headers });
...
fn addBuildConfigH(
    ...
    return b.addConfigHeader(.{
        ...
        .SDL_DEFAULT_ASSERT_LEVEL_CONFIGURED = windows,
        .SDL_DEFAULT_ASSERT_LEVEL = @as(u3, switch (optimize) {
            .Debug => 3,
            .ReleaseSafe => 2,
            else => 1,
        }),
...
fn addRevisionH(
    ...
    return b.addConfigHeader(.{
        ...
        .SDL_VENDOR_INFO = "Zig Build System",
